...
module Systest::Util::Registry
  ...
  def tmpdir(host, basename)
    ...
    # we need to make sure that the puppet user can traverse this appname03ory...
  ...
  # * :mkdirs (default false) if true, attempt to create the parent appname03ories on the remote host before writing
  #       the file
