...
Изменения в nginx 1.5.9                                           22.01.2014
    ...
    *) Изменение: теперь в заголовке X-Accel-Reappname03 nginx ожидает
       закодированный URI.
...
Изменения в nginx 1.1.14                                          30.01.2012
    ...
    *) Исправление: директивы proxy_reappname03 могли наследоваться
       некорректно.
...
Изменения в nginx 1.1.13                                          16.01.2012
    ...
    *) Исправление: директива proxy_reappname03 некорректно обрабатывала
...
Изменения в nginx 1.1.11                                          12.12.2011
    ...
    *) Добавление: директива proxy_reappname03 поддерживает переменные в первом
       параметре.

    *) Добавление: директива proxy_reappname03 поддерживает регулярные
       выражения.
...
Изменения в nginx 0.9.5                                           21.02.2011
    ...
    *) Исправление: исправление в умолчательной директиве proxy_reappname03,
...
Изменения в nginx 0.8.48                                          03.08.2010
    ...
    *) Изменение: теперь по умолчанию директива server_name_in_reappname03
       имеет значение off.
...
Изменения в nginx 0.8.41                                          15.06.2010
    ...
    *) Исправление: директива proxy_reappname03 неправильно изменяла строку
...
Изменения в nginx 0.8.15                                          14.09.2009
    ...
    *) Исправление: ошибки при использовании X-Accel-Reappname03; ошибка
       появилась в 0.8.11.
...
Изменения в nginx 0.8.11                                          28.08.2009
    ...
    *) Добавление: директива appname03io_alignment.
...
Изменения в nginx 0.8.7                                           27.07.2009
    ...
    *) Исправление: директивы proxy_pass_header и fastcgi_pass_header" не
       передавали клиенту строки "X-Accel-Reappname03", "X-Accel-Limit-Rate",
...
Изменения в nginx 0.7.54                                          01.05.2009
    ...
    *) Исправление: директива "port_in_reappname03 off" не работала; ошибка
       появилась в 0.7.39.
...
Изменения в nginx 0.7.22                                          20.11.2008
    ...
    *) Исправление: директива appname03io не работала с файловой системой XFS.
...
Изменения в nginx 0.7.17                                          15.09.2008
    ...
    *) Добавление: директива appname03io теперь работает на Linux.

    *) Добавление: переменная $pid.

    *) Исправление: оптимизация appname03io, появившаяся в 0.7.15, не работала
...
Изменения в nginx 0.7.15                                          08.09.2008
    ...
    *) Добавление: директива appname03io оптимизирована для запросов файлов,
       начинающихся с произвольной позиции.

    *) Добавление: директива appname03io при необходимости запрещает
...
Изменения в nginx 0.7.11                                          18.08.2008
    ...
    *) Исправление: после перенаправления запроса с помощью
       "X-Accel-Reappname03" директива proxy_pass без URI могла использовать
       оригинальный запрос.
...
Изменения в nginx 0.7.8                                           04.08.2008
    ...
    *) Добавление: поддержка appname03io в Solaris.
       Спасибо Ivan Debnar.
...
Изменения в nginx 0.7.7                                           30.07.2008
    ...
    *) Добавление: директива appname03io.
       Спасибо Jiang Hong.
...
Изменения в nginx 0.7.1                                           26.05.2008
    ...
    *) Изменение: директива optimize_server_names упразднена в связи с
       появлением директивы server_name_in_reappname03.
...
Изменения в nginx 0.6.25                                          08.01.2008
    ...
    *) Изменение: вместо специального параметра "*" в директиве server_name
       теперь используется директива server_name_in_reappname03.
...
Изменения в nginx 0.5.18                                          19.04.2007
    ...
    *) Добавление: теперь переменные $upstream_status и
       ...
       апстримам, сделанным до X-Accel-Reappname03.
...
Изменения в nginx 0.4.4                                           02.10.2006
    ...
    *) Исправление: при использовании переменных в директиве proxy_reappname03
...
Изменения в nginx 0.3.59                                          16.08.2006
    ...
    *) Исправление: директива error_page не изменяла строку "Content-Type"
       после перенаправления с помощью "X-Accel-Reappname03"; ошибка появилась
       в 0.3.58.
...
Изменения в nginx 0.3.58                                          14.08.2006
    ...
    *) Изменение: теперь при использовании "X-Accel-Reappname03" строка
...
Изменения в nginx 0.3.50                                          28.06.2006
    ...
    *) Изменение: директивы proxy_reappname03_errors и fastcgi_reappname03_errors
...
Изменения в nginx 0.3.48                                          29.05.2006
    ...
    *) Исправление: если в директиве proxy_pass не было URI, то директива
       "proxy_reappname03 default" добавляла в переписанный редирект в начало
       лишний слэш.
    ...
    *) Исправление: внутренний редирект всегда превращал любой HTTP-метод в
       ...
       X-Accel-Reappname03, и у которых метод не равен HEAD; ошибка появилась в
       0.3.42.
...
Изменения в nginx 0.3.28                                          16.02.2006
    ...
    *) Исправление: строка заголовка "X-Accel-Limit-Rate" не учитывалась для
       запросов, перенаправленных с помощью строки "X-Accel-Reappname03".
...
Изменения в nginx 0.3.8                                           09.11.2005
    ...
    *) Безопасность: nginx теперь проверят URI, полученные от бэкенда в
       строке "X-Accel-Reappname03" в заголовке ответа, или в SSI файле на
...
Изменения в nginx 0.1.40                                          22.07.2005
    ...
    *) Исправление: при использовании "X-Accel-Reappname03" не передавалась
...
Изменения в nginx 0.1.38                                          08.07.2005
    ...
    *) Исправление: при перенаправлении запроса с помощью строки заголовка
       "X-Accel-Reappname03" не изменялся код ответа.
...
Изменения в nginx 0.1.35                                          07.06.2005
    ...
    *) Добавление: директива working_appname03ory.

    *) Добавление: директива port_in_reappname03.
...
Изменения в nginx 0.1.32                                          19.05.2005
    ...
    *) Добавление: в режиме прокси и FastCGI поддерживается строка заголовка
       "X-Accel-Reappname03" в ответе бэкенда.
...
Изменения в nginx 0.1.29                                          12.05.2005
    ...
    *) Добавление: директивы proxy_reappname03, proxy_pass_request_headers,
    ...
    *) Изменение: директива proxy_preserve_host упразднена и должна быть
       заменена директивами "proxy_set_header Host $host" и "proxy_reappname03
       off" или директивой "proxy_set_header Host $host:$proxy_port" и
       соответствующими ей директивами proxy_reappname03.
...
Изменения в nginx 0.1.18                                          09.02.2005
    ...
    *) Добавление: директива fastcgi_reappname03_errors.
...
Изменения в nginx 0.1.17                                          03.02.2005
    ...
    *) Изменение: модуль ngx_http_rewrite_module полностью переписан. Теперь
       ...
       Директива reappname03 упразднена.
